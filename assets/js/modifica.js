document.addEventListener("DOMContentLoaded", function (_) {
  let popUpRegistrati = `<h2>Registrazione</h2>	
	<form id="registratiForm" action="/registration" method="post" onsubmit="return validaForm()">
  ...
  let popUpAccedi = `<h2>Login</h2>
	<form id="loginForm" method="post" onsubmit="return handleLoginForm('loginForm')">
		...
		<button id="buttonAccedi" type="submit">Accedi</button>
	</form>`;
...
function validaForm() {
  ...
  if (password1 !== password2) {
    errorElement.innerText = "Le password non corrispondono!";
...
function handleLoginForm(id_form) {
